 ...
 * Student part begin
 ******************************************************************************/
  int n_sigma = Xsig_pred.cols();
//   std::cout<<"NSigma is: "<<n_sigma<<std::endl;
  float lamb_n_sig = lambda + n_aug;
  for (int i = 1; i <= n_sigma; i++) {
      //set weights
      if (i == 1) {
          weights[i - 1] = lambda/(lamb_n_sig);
      } else {
...
//   std::cout<<"Weights are: "<<weights<<std::endl;
  for (int i = 0; i < n_sigma; i++) {
    ...
    //   std::cout<<"Pred is: "<<Xsig_pred.col(i)<<std::endl;
